...
set CLASSPATH=%APP_HOME%\lib\tic-tac-toe-1.0.jar

@rem Execute tic-tac-toe
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TIC_TAC_TOE_OPTS%  -classpath "%CLASSPATH%" edu.jsu.mcis.TicTacToe %CMD_LINE_ARGS%
